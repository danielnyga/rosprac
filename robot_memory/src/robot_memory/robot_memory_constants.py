...
class Predicates(object):
    ...
    GOAL_DESIGNATOR = Predicate("goalDesignator", Types.TASK, Types.GOAL_KEY, Types.DESIGNATOR_PROPERTY_VALUE)
    DESIGNATOR_TYPE = Predicate("designatorType", Types.DESIGNATOR, -Types.DESIGNATOR_TYPE)
    DESIGNATOR_HASH = Predicate("designatorHash", Types.DESIGNATOR, -Types.DESIGNATOR_PROPERTY_VALUE)
    ...
    PROPERTY_VALUE = Predicate("propertyStringValue", Types.DESIGNATOR_PROPERTY, +Types.DESIGNATOR_PROPERTY_VALUE)
